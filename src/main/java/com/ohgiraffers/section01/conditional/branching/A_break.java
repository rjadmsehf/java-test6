package com.ohgiraffers.section01.conditional.branching;

public class A_break {

    public void testSimpleBerakStatement(){

        /* 목표 break 문 사용에 대한 흐름을 이해하고 적용할 수 있다*/
        /* 필기.
        ...
        while (true) {
                ...
                /* 필기 반복문 조건과 별게로 반복문을 빠져나오기 위한 조건을 다시 작성*/
                if(i == 100) {
